...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        piedata = filtered_df.groupby('Launch Site')['class'].sum().reset_index()
        fig = px.pie(piedata, values='class', 
        names=piedata['Launch Site'], 
        ...
        piedata = filtered_df.groupby('class')['class'].count().reset_index(name='count')
        fig = px.pie(piedata, values='count', 
        names='class',
